...
In a sense, virtual memory is a generalization of the base-and-limit-register idea.
Virtual memory, instead of having separate relocation for just the text and data segments, the entire address space can be mapped onto physical memory in fairly small units.
